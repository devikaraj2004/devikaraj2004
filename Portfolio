...
<body>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p>I'm a <b>student </b> who is passionate about learnimg  new technologies 
              I am a second year Computer Applications student who aims 
              for becoming a specialist in web appication designs in the near future.</p>
